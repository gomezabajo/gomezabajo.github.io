...
[Pablo Gómez-Abajo](https://gomezabajo.github.io) is an Associate Professor (*Profesor Permanente Laboral*) in the [Department of Computer Science](https://www.uam.es/ss/Satellite/EscuelaPolitecnica/es/home.htm) at the [Universidad Autónoma de Madrid (UAM)](https://www.uam.es/).

He earned his degree in Computer Science and Engineering from UAM in 2006 and worked from 2008 to 2015 as IT Manager at [Ingeniería y Prevención de Riesgos](https://imasp.net/). In this role, he led the development of solutions for professionals in other technical fields, including civil, mechanical and risk-prevention engineering. This experience strengthened his ability to understand domain-specific requirements and design accessible, practical solutions. 

In 2015, he joined the [Modelling and Software Engineering Research Group](https://www.miso.es/). His [master's thesis](https://repositorio.uam.es/handle/10486/676054), devoted to the automated generation of educational exercises through model mutation, received a special distinction in 2016. In 2020, he completed his [PhD dissertation](https://repositorio.uam.es/handle/10486/693951) on a domain-specific language for model mutation, earning the highest distinction of *excellent cum laude*.

Alongside his formal degrees, he has pursued extensive continuing education in mathematical thinking, algorithms, optimization, automated software testing, software design, compilers, automata theory, deep learning, process mining, scientific writing, generative AI, and university teaching. This training has included courses and programs offered by institutions such as [Stanford University](https://www.stanford.edu/), [EPFL](https://www.epfl.ch/), [Delft University of Technology](https://www.tudelft.nl/), the [University of Minnesota](https://www.umn.edu/), the [University of Alberta](https://www.ualberta.ca/), [IBM](https://www.ibm.com/), and the [Université de Genève](https://www.unige.ch/).
